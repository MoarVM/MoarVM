...
<<<<<<< HEAD
    ...
    'sp_guardobj', 825,
    'sp_guardnotobj', 826,
    'sp_guardjustconc', 827,
    'sp_guardjusttype', 828,
    'sp_rebless', 829,
    'sp_resolvecode', 830,
    'sp_decont', 831,
    'sp_getlex_o', 832,
    ...
    'sp_fastbox_bi', 876,
    'sp_fastbox_i_ic', 877,
    'sp_fastbox_bi_ic', 878,
    'sp_deref_get_i64', 879,
    'sp_deref_get_n', 880,
    'sp_deref_bind_i64', 881,
    'sp_deref_bind_n', 882,
    'sp_getlexvia_o', 883,
    'sp_getlexvia_ins', 884,
    'sp_getstringfrom', 885,
    'sp_getwvalfrom', 886,
    'sp_jit_enter', 887,
    'sp_boolify_iter', 888,
    'sp_boolify_iter_arr', 889,
    'sp_boolify_iter_hash', 890,
    'sp_cas_o', 891,
    'sp_atomicload_o', 892,
    'sp_atomicstore_o', 893,
    'sp_add_I', 894,
    'sp_sub_I', 895,
    'sp_mul_I', 896,
    'sp_bool_I', 897,
    'prof_enter', 898,
    'prof_enterspesh', 899,
    'prof_enterinline', 900,
    'prof_enternative', 901,
    'prof_exit', 902,
    'prof_allocated', 903,
    'ctw_check', 904,
    'coverage_log', 905,
...
=======
    ...
    'sp_guardobj', 827,
    'sp_guardnotobj', 828,
    'sp_guardjustconc', 829,
    'sp_guardjusttype', 830,
    'sp_rebless', 831,
    'sp_resolvecode', 832,
    'sp_decont', 833,
    'sp_getlex_o', 834,
    ...
    'sp_fastbox_bi', 878,
    'sp_fastbox_i_ic', 879,
    'sp_fastbox_bi_ic', 880,
    'sp_deref_get_i64', 881,
    'sp_deref_get_n', 882,
    'sp_deref_bind_i64', 883,
    'sp_deref_bind_n', 884,
    'sp_getlexvia_o', 885,
    'sp_getlexvia_ins', 886,
    'sp_getstringfrom', 887,
    'sp_getwvalfrom', 888,
    'sp_jit_enter', 889,
    'sp_boolify_iter', 890,
    'sp_boolify_iter_arr', 891,
    'sp_boolify_iter_hash', 892,
    'sp_cas_o', 893,
    'sp_atomicload_o', 894,
    'sp_atomicstore_o', 895,
    'sp_add_I', 896,
    'sp_sub_I', 897,
    'sp_mul_I', 898,
    'sp_bool_I', 899,
    'prof_enter', 900,
    'prof_enterspesh', 901,
    'prof_enterinline', 902,
    'prof_enternative', 903,
    'prof_exit', 904,
    'prof_allocated', 905,
    'ctw_check', 906,
    'coverage_log', 907,
...
>>>>>>> Implement getsockopts op
    ...
    'prepargs', sub ($op0) {
        my $bytecode := $*MAST_FRAME.bytecode;
        my uint $elems := nqp::elems($bytecode);
        nqp::writeuint($bytecode, $elems, 127, 5);
...
=======
    ...
    'sp_guard', sub ($op0, $op1, $op2, uint32 $op3) {
        ...
        {my int $value := $op3;
                    ...
                    nqp::writeuint($bytecode, nqp::add_i($elems, 6), $value, 13);}
    },
    ...
    'sp_rebless', sub ($op0, $op1, $op2, uint32 $op3) {
        ...
        {my int $value := $op3;
                    ...
                    nqp::writeuint($bytecode, nqp::add_i($elems, 8), $value, 13);}
    },
    ...
    'sp_fastbox_i', sub ($op0, int16 $op1, $op2, int16 $op3, $op4) {
        ...
        {my int $value := $op3;
                    ...
                    nqp::writeuint($bytecode, nqp::add_i($elems, 6), $value, 5);}
        my uint $index4 := nqp::unbox_u($op4); nqp::writeuint($bytecode, nqp::add_i($elems, 8), $index4, 5);
    },
    ...
    'sp_add_I', sub ($op0, int16 $op1, $op2, $op3, $op4, int16 $op5, int16 $op6) {
        ...
        my uint $index3 := nqp::unbox_u($op3); nqp::writeuint($bytecode, nqp::add_i($elems, 6), $index3, 5);
        my uint $index4 := nqp::unbox_u($op4); nqp::writeuint($bytecode, nqp::add_i($elems, 8), $index4, 5);
        {my int $value := $op5;
                    if $value < -32768 || 32767 < $value {
                        nqp::die("Value outside range of 16-bit MAST::IVal");
    ...
    'coverage_log', sub (str $op0, int32 $op1, int32 $op2, int64 $op3) {
        ...
        {my int $value := $op2;
                    ...
                    nqp::writeuint($bytecode, nqp::add_i($elems, 14), $value, 13);}
        {my int $value := $op3; nqp::writeuint($bytecode, nqp::add_i($elems, 22), $value, 13);}
    },
...
>>>>>>> Socket options bug fixes
        {my int $value := $op0;
                    ...
                    nqp::writeuint($bytecode, nqp::add_i($elems, 2), $value, 13);}
        {my int $value := $op1;
                    if $value < -2147483648 || 2147483647 < $value {
                        nqp::die("Value outside range of 32-bit MAST::IVal");
                    }
