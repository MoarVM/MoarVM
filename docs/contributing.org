...
advised to take advantage of this. The author uses the following
configuration:
...
branches should be rebased to keep up to date with main. Bugfixes
can go to main directly.
