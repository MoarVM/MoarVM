...
*** TODO Replace 'invokish' and 'throwish' check code with return address updates
...
This calls for an abstraction: =MVM_jit_code_set_continuation_label=
that sets the return address or reentry label as needed.
