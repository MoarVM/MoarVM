...
my %TP_LF = (
    ...
    path  => '3rdparty',
    rule  => 'cd 3rdparty/libffi && ./autogen.sh && ./configure --disable-docs --prefix=' . catdir(rel2abs(), '3rdparty', 'libffi', 'install') . ' && CC=\'$(CC)\' CFLAGS=\'$(CFLAGS)\' $(MAKE) install',
