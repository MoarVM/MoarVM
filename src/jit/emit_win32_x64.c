...
//|.actionlist actions
static const unsigned char actions[1650] = {
  ...
  131,233,255,76,139,139,233,255,76,139,155,233,65,83,255,102,72,15,110,131,
  233,255,102,72,15,110,139,233,255,102,72,15,110,147,233,255,102,72,15,110,
  155,233,255,76,141,155,233,255,77,139,157,233,77,139,155,233,255,72,199,193,
  237,255,72,199,194,237,255,73,199,192,237,255,73,199,193,237,255,73,199,195,
  237,65,83,255,73,187,237,237,255,102,73,15,110,195,255,102,73,15,110,203,
  255,102,73,15,110,211,255,102,73,15,110,219,255,72,139,8,72,137,139,233,255,
  72,139,139,233,72,137,8,255,73,131,190,233,0,15,132,244,247,76,137,252,241,
  73,186,237,237,72,131,252,236,32,65,252,255,210,72,131,196,32,248,1,255,252,
  ...
  210,72,131,196,32,73,137,195,255,77,139,148,253,36,233,255,76,139,139,233,
  ...
  18,73,137,148,253,36,233,255,72,141,21,245,73,137,148,253,36,233,255,65,82,
  ...
  252,255,210,72,131,196,32,255,72,199,192,1,0,0,0,252,233,244,11,255,77,59,
...
#line 777 "src/jit/emit_x64.dasc"
    ...
    case MVM_JIT_REG_VAL:
        ...
        switch(i) {
            case 0:
        dasm_put(Dst, 1038, Dt11([arg.v.reg]));
                break;
            case 1:
        dasm_put(Dst, 1043, Dt11([arg.v.reg]));
                break;
            case 2:
        dasm_put(Dst, 1048, Dt11([arg.v.reg]));
                break;
            case 3:
        dasm_put(Dst, 1053, Dt11([arg.v.reg]));
                break;
            default:
        dasm_put(Dst, 1058, Dt11([arg.v.reg]));
        }
#line 782 "src/jit/emit_x64.dasc"
    ...
    case MVM_JIT_REG_VAL_F:
        ...
        switch(i) {
            case 0:
        dasm_put(Dst, 1065, Dt11([arg.v.reg]));
                break;
            case 1:
        dasm_put(Dst, 1072, Dt11([arg.v.reg]));
                break;
            case 2:
        dasm_put(Dst, 1079, Dt11([arg.v.reg]));
                break;
            case 3:
        dasm_put(Dst, 1086, Dt11([arg.v.reg]));
                break;
            default:
        dasm_put(Dst, 1058, Dt11([arg.v.reg]));
                break;
...
#line 785 "src/jit/emit_x64.dasc"
    ...
    case MVM_JIT_REG_ADDR:
        ...
        //| addarg i, TMP6;
        dasm_put(Dst, 1093, Dt11([arg.v.reg]));
        switch(i) {
            case 0:
        dasm_put(Dst, 1016);
                break;
...
#line 789 "src/jit/emit_x64.dasc"
    ...
    case MVM_JIT_STR_IDX:
        ...
        //| addarg i, TMP6;
        dasm_put(Dst, 1098, Dt13(->body.strings), DtA([arg.v.lit_i64]));
        switch(i) {
            case 0:
        dasm_put(Dst, 1016);
                break;
...
#line 793 "src/jit/emit_x64.dasc"
    ...
    case MVM_JIT_LITERAL:
        ...
        switch(i) {
            case 0:
        dasm_put(Dst, 1107, arg.v.lit_i64);
                break;
            case 1:
        dasm_put(Dst, 1112, arg.v.lit_i64);
                break;
            case 2:
        dasm_put(Dst, 1117, arg.v.lit_i64);
                break;
            case 3:
        dasm_put(Dst, 1122, arg.v.lit_i64);
                break;
            default:
        dasm_put(Dst, 1127, arg.v.lit_i64);
        }
#line 796 "src/jit/emit_x64.dasc"
    ...
    case MVM_JIT_LITERAL_PTR:
        ...
        //| addarg i, TMP6;
        dasm_put(Dst, 1134, (unsigned int)(arg.v.lit_i64), (unsigned int)((arg.v.lit_i64)>>32));
        switch(i) {
            case 0:
        dasm_put(Dst, 1016);
                break;
...
#line 892 "src/jit/emit_x64.dasc"
    ...
    case MVM_JIT_RV_DEREF:
        ...
        dasm_put(Dst, 1163, Dt11([call_spec->rv_idx]));
#line 896 "src/jit/emit_x64.dasc"
    ...
    case MVM_JIT_RV_ADDR:
        ...
        //| mov [RV], TMP1;
        dasm_put(Dst, 1171, Dt11([call_spec->rv_idx]));
...
void MVM_jit_emit_branch(MVMThreadContext *tc, MVMJitGraph *jg,
    ...
    //| gc_sync_point;
    dasm_put(Dst, 1179, Dt10(->gc_status), (unsigned int)((uintptr_t)&MVM_gc_enter_from_interrupt), (unsigned int)(((uintptr_t)&MVM_gc_enter_from_interrupt)>>32));
...
#line 918 "src/jit/emit_x64.dasc"
        ...
        case MVM_OP_if_i:
            ...
            dasm_put(Dst, 1221, Dt11([reg]), (name));
#line 928 "src/jit/emit_x64.dasc"
        ...
        case MVM_OP_unless_i:
            ...
            //| test rax, rax;
            //| jz =>(name);
            dasm_put(Dst, 1232, Dt11([reg]), (name));
#line 933 "src/jit/emit_x64.dasc"
        ...
        case MVM_OP_ifnonnull:
            ...
            //| jmp =>(name);
            //|1:
            dasm_put(Dst, 1243, Dt11([reg]), Dt10(->instance), Dt6(->VMNull), (name));
...
void MVM_jit_emit_guard(MVMThreadContext *tc, MVMJitGraph *jg,
    ...
    dasm_put(Dst, 1275, Dt11([obj]), Dt12(->effective_spesh_slots), DtB([spesh_idx]));
...
#line 972 "src/jit/emit_x64.dasc"
        ...
        //| is_type_object TMP1;
        dasm_put(Dst, 1300, Dt7(->header.flags), MVM_CF_TYPE_OBJECT);
...
#line 994 "src/jit/emit_x64.dasc"
    ...
    dasm_put(Dst, 1327, guard->deopt_offset, guard->deopt_target, (unsigned int)((uintptr_t)&MVM_spesh_deopt_one_direct), (unsigned int)(((uintptr_t)&MVM_spesh_deopt_one_direct)>>32));
#line 999 "src/jit/emit_x64.dasc"
    /* tell jit driver we're deopting */
    //| mov RV, MVM_JIT_CTRL_DEOPT
    //| jmp ->out;
    //|2:
    dasm_put(Dst, 1357, MVM_JIT_CTRL_DEOPT);
...
void MVM_jit_emit_invoke(MVMThreadContext *tc, MVMJitGraph *jg, MVMJitInvoke *invoke,
    ...
    dasm_put(Dst, 1368, invoke->callsite_idx, (unsigned int)((uintptr_t)&MVM_args_prepare), (unsigned int)(((uintptr_t)&MVM_args_prepare)>>32));
...
#line 1017 "src/jit/emit_x64.dasc"
    for (i = 0;  i < invoke->arg_count; i++) {
        ...
        case MVM_OP_arg_o: {
            ...
            dasm_put(Dst, 1408, Dt11([src]), Dt1([dst]));
#line 1028 "src/jit/emit_x64.dasc"
        ...
        case MVM_OP_argconst_i: {
            ...
            //| mov64 TMP4, val;
            //| mov REGISTER:TMP5[dst], TMP4;
            dasm_put(Dst, 1417, (unsigned int)(val), (unsigned int)((val)>>32), Dt1([dst]));
#line 1036 "src/jit/emit_x64.dasc"
        ...
        case MVM_OP_argconst_s: {
            ...
            //| get_string TMP4, idx;
            //| mov REGISTER:TMP5[dst], TMP4;
            dasm_put(Dst, 1426, Dt13(->body.strings), DtA([idx]), Dt1([dst]));
#line 1043 "src/jit/emit_x64.dasc"
    ...
    if (sizeof(MVMReturnType) == 4) {
        ...
        dasm_put(Dst, 1439, Dt12(->return_type), invoke->return_type);
...
#line 1067 "src/jit/emit_x64.dasc"
    ...
    dasm_put(Dst, 1480, (invoke->reentry_label), Dt12(->jit_entry_label));
...
#line 1077 "src/jit/emit_x64.dasc"
        ...
        dasm_put(Dst, 1496, Dt11([invoke->code_register]), (unsigned int)((uintptr_t)&MVM_frame_find_invokee_multi_ok), (unsigned int)(((uintptr_t)&MVM_frame_find_invokee_multi_ok)>>32));
...
#line 1091 "src/jit/emit_x64.dasc"
        ...
        //| callr FUNCTION;
        dasm_put(Dst, 1547, Dt7(->st), Dt9(->invoke));
#line 1095 "src/jit/emit_x64.dasc"
        ...
        dasm_put(Dst, 1569, Dt11([invoke->code_register]), invoke->spesh_cand, (unsigned int)((uintptr_t)&MVM_frame_invoke_code), (unsigned int)(((uintptr_t)&MVM_frame_invoke_code)>>32));
...
void MVM_jit_emit_control(MVMThreadContext *tc, MVMJitGraph *jg,
    ...
    if (ctrl->type == MVM_JIT_CONTROL_INVOKISH) {
        ...
        //| jmp ->out;
        //|1:
        dasm_put(Dst, 1614, Dt10(->cur_frame), Dt12(->jit_entry_label));
