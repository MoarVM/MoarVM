...
//|.actionlist actions
static const unsigned char actions[1390] = {
  ...
  255,76,137,252,241,255,76,137,252,242,255,77,137,252,240,255,77,137,252,241,
  255,73,139,150,233,255,77,139,134,233,255,77,139,142,233,255,76,137,252,233,
  255,76,137,252,234,255,77,137,232,255,77,137,252,233,255,72,139,139,233,255,
  72,139,147,233,255,76,139,131,233,255,76,139,139,233,255,252,242,15,16,139,
  233,255,252,242,15,16,147,233,255,252,242,15,16,155,233,255,76,141,155,233,
  255,76,137,217,255,76,137,218,255,77,137,216,255,77,137,217,255,72,199,193,
  237,255,72,199,194,237,255,73,199,192,237,255,73,199,193,237,255,73,187,237,
  ...
  192,237,73,186,237,237,72,131,252,236,32,65,252,255,210,72,131,196,32,73,
  137,195,255,76,139,145,233,255,76,139,139,233,77,137,138,233,255,73,185,237,
  237,77,137,138,233,255,77,139,141,233,77,139,137,233,77,137,138,233,255,199,
  129,233,237,255,72,199,129,233,237,255,72,141,147,233,72,137,145,233,255,
  73,139,150,233,72,139,18,72,137,145,233,255,65,82,65,83,255,76,137,252,241,
  72,139,147,233,73,137,224,77,137,209,73,186,237,237,72,131,252,236,32,65,
  252,255,210,72,131,196,32,255,65,91,65,90,255,76,137,252,241,72,137,194,77,
  137,216,77,137,209,255,76,139,144,233,77,139,146,233,72,131,252,236,32,65,
  252,255,210,72,131,196,32,255,76,137,252,241,72,139,147,233,77,137,216,73,
  199,193,237,73,186,237,237,72,131,252,236,32,65,252,255,210,72,131,196,32,
...
#line 697 "src/jit/emit_x64.dasc"
    ...
    case MVM_OP_sp_fastcreate: {
        ...
        dasm_put(Dst, 818, size, (unsigned int)((uintptr_t)&MVM_gc_allocate_zeroed), (unsigned int)(((uintptr_t)&MVM_gc_allocate_zeroed)>>32), Dt10(->cur_frame), Dt1(->effective_spesh_slots), DtC([spesh_idx]), Dt8(->st), Dt8(->header.size), size, Dt10(->thread_id), Dt8(->header.owner), Dt11([dst]));
...
#line 735 "src/jit/emit_x64.dasc"
            ...
            case MVM_JIT_INTERP_FRAME:
                ...
                dasm_put(Dst, 114, Dt10(->cur_frame));
                        break;
                    case 1:
                dasm_put(Dst, 896, Dt10(->cur_frame));
                        break;
                    case 2:
                dasm_put(Dst, 901, Dt10(->cur_frame));
                        break;
                    case 3:
                dasm_put(Dst, 906, Dt10(->cur_frame));
                        break;
                    default:
                        MVM_exception_throw_adhoc(tc, "Can't JIT more than %d arguments", i);
                }
...
#line 741 "src/jit/emit_x64.dasc"
        ...
        case MVM_JIT_REG_VAL:
            ...
            dasm_put(Dst, 930, Dt11([args[i].v.reg]));
                    break;
                case 1:
            dasm_put(Dst, 935, Dt11([args[i].v.reg]));
                    break;
                case 2:
            dasm_put(Dst, 940, Dt11([args[i].v.reg]));
                    break;
                case 3:
            dasm_put(Dst, 945, Dt11([args[i].v.reg]));
                    break;
                default:
                    MVM_exception_throw_adhoc(tc, "Can't JIT more than %d arguments", i);
            }
#line 746 "src/jit/emit_x64.dasc"
        ...
        case MVM_JIT_REG_VAL_F:
            ...
            dasm_put(Dst, 712, Dt11([args[i].v.reg]));
                    break;
                case 1:
            dasm_put(Dst, 950, Dt11([args[i].v.reg]));
                    break;
                case 2:
            dasm_put(Dst, 957, Dt11([args[i].v.reg]));
                    break;
                case 3:
            dasm_put(Dst, 964, Dt11([args[i].v.reg]));
                    break;
                default:
                    MVM_exception_throw_adhoc(tc, "Can't JIT more than %d arguments", i);
            }
#line 749 "src/jit/emit_x64.dasc"
        ...
        case MVM_JIT_REG_ADDR:
            ...
            //| addarg i, TMP6;
            dasm_put(Dst, 971, Dt11([args[i].v.reg]));
            switch(i) {
                case 0:
            dasm_put(Dst, 976);
                    break;
...
#line 753 "src/jit/emit_x64.dasc"
        case MVM_JIT_LITERAL:
            ...
            switch(i) {
                case 0:
            dasm_put(Dst, 992, args[i].v.lit_i64);
                    break;
                case 1:
            dasm_put(Dst, 997, args[i].v.lit_i64);
                    break;
                case 2:
            dasm_put(Dst, 1002, args[i].v.lit_i64);
                    break;
                case 3:
            dasm_put(Dst, 1007, args[i].v.lit_i64);
                    break;
                default:
                    MVM_exception_throw_adhoc(tc, "Can't JIT more than %d arguments", i);
            }
#line 755 "src/jit/emit_x64.dasc"
        ...
        case MVM_JIT_LITERAL_F:
            ...
            //| addarg i, TMP6;
            dasm_put(Dst, 1012, (unsigned int)(args[i].v.lit_i64), (unsigned int)((args[i].v.lit_i64)>>32));
            switch(i) {
                case 0:
            dasm_put(Dst, 976);
                    break;
...
#line 777 "src/jit/emit_x64.dasc"
    ...
    case MVM_JIT_RV_DEREF:
        ...
        dasm_put(Dst, 1017, Dt11([call_spec->rv_idx]));
#line 781 "src/jit/emit_x64.dasc"
    ...
    case MVM_JIT_RV_ADDR:
        ...
        //| mov [RV], TMP1;
        dasm_put(Dst, 1025, Dt11([call_spec->rv_idx]));
...
#line 800 "src/jit/emit_x64.dasc"
        ...
        case MVM_OP_if_i:
            ...
            dasm_put(Dst, 1042, Dt11([reg]), (name));
#line 810 "src/jit/emit_x64.dasc"
        ...
        case MVM_OP_unless_i:
            ...
            //| test rax, rax;
            //| jz =>(name);
            dasm_put(Dst, 1053, Dt11([reg]), (name));
...
void MVM_jit_emit_guard(MVMThreadContext *tc, MVMJitGraph *jg,
    ...
    dasm_put(Dst, 1064, Dt11([obj]), Dt10(->cur_frame), Dt1(->effective_spesh_slots), DtC([spesh_idx]));
...
#line 856 "src/jit/emit_x64.dasc"
        ...
        //| is_type_object TMP1;
        //| jnz >1;
        dasm_put(Dst, 1107, Dt8(->header.flags), MVM_CF_TYPE_OBJECT);
...
#line 866 "src/jit/emit_x64.dasc"
    ...
    dasm_put(Dst, 1125, guard->deopt_offset, guard->deopt_target, (unsigned int)((uintptr_t)&MVM_spesh_deopt_one_direct), (unsigned int)(((uintptr_t)&MVM_spesh_deopt_one_direct)>>32));
#line 871 "src/jit/emit_x64.dasc"
    /* tell jit driver we're deopting */
    //| mov RV, MVM_JIT_CTRL_DEOPT
    //| jmp ->out;
    //|2:
    dasm_put(Dst, 1155, MVM_JIT_CTRL_DEOPT);
...
void MVM_jit_emit_invoke(MVMThreadContext *tc, MVMJitGraph *jg, MVMJitInvoke *invoke,
    ...
    dasm_put(Dst, 1166, invoke->callsite_idx, (unsigned int)((uintptr_t)&MVM_args_prepare), (unsigned int)(((uintptr_t)&MVM_args_prepare)>>32));
...
#line 891 "src/jit/emit_x64.dasc"
    for (i = 0;  i < invoke->arg_count; i++) {
        ...
        case MVM_OP_arg_o: {
            ...
            dasm_put(Dst, 1204, Dt11([src]), Dt2([dst]));
#line 902 "src/jit/emit_x64.dasc"
        ...
        case MVM_OP_argconst_i: {
            ...
            //| mov64 TMP4, val;
            //| mov REGISTER:TMP5[dst], TMP4;
            dasm_put(Dst, 1213, (unsigned int)(val), (unsigned int)((val)>>32), Dt2([dst]));
#line 910 "src/jit/emit_x64.dasc"
        ...
        case MVM_OP_argconst_s: {
            ...
            //| get_string TMP4, idx;
            //| mov REGISTER:TMP5[dst], TMP4;
            dasm_put(Dst, 1222, Dt13(->body.strings), DtB([idx]), Dt2([dst]));
#line 917 "src/jit/emit_x64.dasc"
    ...
    if (sizeof(MVMReturnType) == 4) {
        ...
        dasm_put(Dst, 1235, Dt1(->return_type), invoke->return_type);
...
#line 941 "src/jit/emit_x64.dasc"
    ...
    dasm_put(Dst, 1235, Dt1(->jit_entry_label), invoke->reentry_label);
...
#line 950 "src/jit/emit_x64.dasc"
        ...
        dasm_put(Dst, 1272, Dt11([invoke->code_register]), (unsigned int)((uintptr_t)&MVM_frame_find_invokee_multi_ok), (unsigned int)(((uintptr_t)&MVM_frame_find_invokee_multi_ok)>>32));
...
#line 964 "src/jit/emit_x64.dasc"
        ...
        //| callr FUNCTION;
        dasm_put(Dst, 1323, Dt8(->st), DtA(->invoke));
#line 968 "src/jit/emit_x64.dasc"
        ...
        dasm_put(Dst, 1345, Dt11([invoke->code_register]), invoke->spesh_cand, (unsigned int)((uintptr_t)&MVM_frame_invoke_code), (unsigned int)(((uintptr_t)&MVM_frame_invoke_code)>>32));
