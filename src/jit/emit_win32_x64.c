...
//|.actionlist actions
static const unsigned char actions[1847] = {
  ...
  15,156,209,255,15,146,209,255,72,15,182,201,72,137,139,233,255,76,137,252,
  241,72,199,194,237,73,186,237,237,65,252,255,210,73,139,140,253,36,233,72,
  139,137,233,72,137,136,233,102,199,128,233,236,65,139,142,233,137,136,233,
  72,137,131,233,255,76,139,147,233,77,133,210,255,15,132,244,247,102,65,252,
  247,130,233,236,255,15,133,244,247,77,139,154,233,77,139,155,233,77,133,219,
  255,15,132,244,247,76,137,252,241,76,137,210,76,141,131,233,77,139,147,233,
  65,252,255,210,252,233,244,248,248,1,255,76,137,147,233,248,2,255,73,139,
  140,253,36,233,198,129,233,1,255,73,139,140,253,36,233,72,139,137,233,72,
  139,147,233,72,139,146,233,72,57,209,15,133,244,247,77,139,132,253,36,233,
  77,139,128,233,76,137,131,233,252,233,244,248,248,1,76,137,252,241,72,139,
  147,233,77,139,133,233,77,139,128,233,73,199,193,237,76,141,155,233,76,137,
  92,36,32,73,186,237,237,65,252,255,210,72,133,192,15,132,244,248,255,72,199,
...
#line 721 "src/jit/emit_x64.dasc"
    ...
    case MVM_OP_sp_fastcreate: {
        ...
        dasm_put(Dst, 912, size, (unsigned int)((uintptr_t)&MVM_gc_allocate_zeroed), (unsigned int)(((uintptr_t)&MVM_gc_allocate_zeroed)>>32), Dt14(->effective_spesh_slots), DtB([spesh_idx]), Dt7(->st), Dt7(->header.size), size, Dt12(->thread_id), Dt7(->header.owner), Dt13([dst]));
#line 737 "src/jit/emit_x64.dasc"
    ...
    case MVM_OP_decont: {
        ...
        //| mov TMP5, WORK[src];
        //| test TMP5, TMP5;
        dasm_put(Dst, 959, Dt13([src]));
#line 744 "src/jit/emit_x64.dasc"
        // obj is null
        //| jz >1;
        //| is_type_object TMP5;
        dasm_put(Dst, 967, Dt7(->header.flags), MVM_CF_TYPE_OBJECT);
#line 747 "src/jit/emit_x64.dasc"
        ...
        //| test TMP6, TMP6;
        dasm_put(Dst, 979, Dt7(->st), Dt9(->container_spec));
...
#line 764 "src/jit/emit_x64.dasc"
    ...
    case MVM_OP_sp_namedarg_used: {
        ...
        dasm_put(Dst, 1032, Dt14(->params.named_used), DtE([param]));
#line 770 "src/jit/emit_x64.dasc"
    ...
    case MVM_OP_sp_findmeth: {
        ...
        //| test RV, RV;
        //| jz >2;
        dasm_put(Dst, 1043, Dt14(->effective_spesh_slots), DtB([ss_idx]), Dt13([obj]), Dt7(->st), Dt14(->effective_spesh_slots), DtB([ss_idx + 1]), Dt13([dst]), Dt13([obj]), Dt15(->body.strings), DtA([str_idx]), ss_idx, Dt13([dst]), (unsigned int)((uintptr_t)&MVM_6model_find_method_spesh), (unsigned int)(((uintptr_t)&MVM_6model_find_method_spesh)>>32));
#line 799 "src/jit/emit_x64.dasc"
        ...
        //| jmp ->out;
        //|2:
        dasm_put(Dst, 1133, Dt14(->jit_entry_label));
#line 805 "src/jit/emit_x64.dasc"
    ...
    case MVM_OP_isconcrete: {
        ...
        //| mov qword WORK[dst], 0;
        //|2:
        dasm_put(Dst, 1158, Dt13([obj]), Dt7(->header.flags), MVM_CF_TYPE_OBJECT, Dt13([dst]), Dt13([dst]));
...
#line 849 "src/jit/emit_x64.dasc"
    ...
    case MVM_JIT_REG_VAL:
        ...
        dasm_put(Dst, 1228, Dt13([arg.v.reg]));
...
#line 866 "src/jit/emit_x64.dasc"
    ...
    case MVM_JIT_LITERAL_F:
        ...
        dasm_put(Dst, 1252, (unsigned int)(arg.v.lit_i64), (unsigned int)((arg.v.lit_i64)>>32));
...
#line 1064 "src/jit/emit_x64.dasc"
    ...
    case MVM_JIT_RV_DEREF:
        ...
        dasm_put(Dst, 1319, Dt13([call_spec->rv_idx]));
#line 1068 "src/jit/emit_x64.dasc"
    ...
    case MVM_JIT_RV_ADDR:
        ...
        //| mov [RV], TMP1;
        dasm_put(Dst, 1327, Dt13([call_spec->rv_idx]));
...
void MVM_jit_emit_branch(MVMThreadContext *tc, MVMJitGraph *jg,
    ...
    //| gc_sync_point;
    dasm_put(Dst, 1335, Dt12(->gc_status), (unsigned int)((uintptr_t)&MVM_gc_enter_from_interrupt), (unsigned int)(((uintptr_t)&MVM_gc_enter_from_interrupt)>>32));
...
#line 1090 "src/jit/emit_x64.dasc"
        ...
        case MVM_OP_if_i:
            ...
            dasm_put(Dst, 1368, Dt13([val]), (name));
#line 1100 "src/jit/emit_x64.dasc"
        ...
        case MVM_OP_unless_i:
            ...
            //| test rax, rax;
            //| jz =>(name);
            dasm_put(Dst, 1379, Dt13([val]), (name));
#line 1105 "src/jit/emit_x64.dasc"
        ...
        case MVM_OP_ifnonnull:
            ...
            //| jmp =>(name);
            //|1:
            dasm_put(Dst, 1390, Dt13([val]), Dt12(->instance), Dt6(->VMNull), (name));
#line 1115 "src/jit/emit_x64.dasc"
        ...
        case MVM_OP_indexat: {
            ...
            //| cmp RV, 0;
            //| jl =>(name);
            dasm_put(Dst, 1422, Dt13([val]), Dt13([offset]), Dt15(->body.strings), DtA([str_idx]), (unsigned int)((uintptr_t)&MVM_string_char_at_in_string), (unsigned int)(((uintptr_t)&MVM_string_char_at_in_string)>>32), (name));
...
void MVM_jit_emit_guard(MVMThreadContext *tc, MVMJitGraph *jg,
    ...
    dasm_put(Dst, 1459, Dt13([obj]), Dt14(->effective_spesh_slots), DtB([spesh_idx]));
...
#line 1156 "src/jit/emit_x64.dasc"
        ...
        //| is_type_object TMP1;
        dasm_put(Dst, 1484, Dt7(->header.flags), MVM_CF_TYPE_OBJECT);
...
#line 1168 "src/jit/emit_x64.dasc"
        ...
        //| is_type_object TMP1;
        //| jnz >1;
        dasm_put(Dst, 1500, Dt7(->header.flags), MVM_CF_TYPE_OBJECT);
...
#line 1178 "src/jit/emit_x64.dasc"
    ...
    dasm_put(Dst, 1511, guard->deopt_offset, guard->deopt_target, (unsigned int)((uintptr_t)&MVM_spesh_deopt_one_direct), (unsigned int)(((uintptr_t)&MVM_spesh_deopt_one_direct)>>32));
#line 1183 "src/jit/emit_x64.dasc"
    /* tell jit driver we're deopting */
    //| mov RV, MVM_JIT_CTRL_DEOPT
    //| jmp ->out;
    //|2:
    dasm_put(Dst, 1532, MVM_JIT_CTRL_DEOPT);
...
void MVM_jit_emit_invoke(MVMThreadContext *tc, MVMJitGraph *jg, MVMJitInvoke *invoke,
    ...
    dasm_put(Dst, 1543, invoke->callsite_idx, (unsigned int)((uintptr_t)&MVM_args_prepare), (unsigned int)(((uintptr_t)&MVM_args_prepare)>>32));
...
#line 1201 "src/jit/emit_x64.dasc"
    for (i = 0;  i < invoke->arg_count; i++) {
        ...
        case MVM_OP_arg_o: {
            ...
            dasm_put(Dst, 1574, Dt13([src]), Dt1([dst]));
#line 1212 "src/jit/emit_x64.dasc"
        ...
        case MVM_OP_argconst_i: {
            ...
            //| mov64 TMP4, val;
            //| mov REGISTER:TMP5[dst], TMP4;
            dasm_put(Dst, 1583, (unsigned int)(val), (unsigned int)((val)>>32), Dt1([dst]));
#line 1220 "src/jit/emit_x64.dasc"
        ...
        case MVM_OP_argconst_s: {
            ...
            //| get_string TMP4, idx;
            //| mov REGISTER:TMP5[dst], TMP4;
            dasm_put(Dst, 1592, Dt15(->body.strings), DtA([idx]), Dt1([dst]));
#line 1227 "src/jit/emit_x64.dasc"
    ...
    if (sizeof(MVMReturnType) == 4) {
        ...
        dasm_put(Dst, 1605, Dt14(->return_type), invoke->return_type);
...
#line 1251 "src/jit/emit_x64.dasc"
    ...
    dasm_put(Dst, 1646, (invoke->reentry_label), Dt14(->jit_entry_label));
...
#line 1261 "src/jit/emit_x64.dasc"
        ...
        dasm_put(Dst, 1666, Dt13([invoke->code_register]), (unsigned int)((uintptr_t)&MVM_frame_find_invokee_multi_ok), (unsigned int)(((uintptr_t)&MVM_frame_find_invokee_multi_ok)>>32));
...
#line 1275 "src/jit/emit_x64.dasc"
        ...
        //| call FUNCTION;
        dasm_put(Dst, 1713, Dt7(->st), Dt9(->invoke));
#line 1279 "src/jit/emit_x64.dasc"
        ...
        dasm_put(Dst, 1726, Dt13([invoke->code_register]), invoke->spesh_cand, (unsigned int)((uintptr_t)&MVM_frame_invoke_code), (unsigned int)(((uintptr_t)&MVM_frame_invoke_code)>>32));
...
void MVM_jit_emit_jumplist(MVMThreadContext *tc, MVMJitGraph *jg,
    ...
    //|.align 8;
    //|1:
    dasm_put(Dst, 1762, Dt13([jumplist->reg]), jumplist->num_labels);
#line 1306 "src/jit/emit_x64.dasc"
    for (i = 0; i < jumplist->num_labels; i++) {
        //|=>(jumplist->in_labels[i]):
        //| jmp =>(jumplist->out_labels[i]);
        //|.align 8;
        dasm_put(Dst, 1804, (jumplist->in_labels[i]), (jumplist->out_labels[i]));
...
void MVM_jit_emit_control(MVMThreadContext *tc, MVMJitGraph *jg,
    ...
    if (ctrl->type == MVM_JIT_CONTROL_INVOKISH) {
        ...
        //| jmp ->out;
        //|1:
        dasm_put(Dst, 1811, Dt12(->cur_frame), Dt14(->jit_entry_label));
