"src/jit/emit_x64.dasc"
        ...
        dasm_put(Dst, 252, Dt15(->env), Dt14([src]), Dt1([idx]));
#line 373 "src/jit/emit_x64.dasc"
    ...
    case MVM_OP_sp_getarg_i: {
        ...
        //| mov WORK[reg], TMP1;
        dasm_put(Dst, 265, Dt15(->params.args), Dt1([idx]), Dt14([reg]));
#line 384 "src/jit/emit_x64.dasc"
    ...
    case MVM_OP_sp_p6ogetvt_o: {
        ...
        //| test TMP4, TMP4;
        //| cmovnz TMP2, TMP5;
        dasm_put(Dst, 280, Dt14([obj]), (offset + body), Dt4(->body.replaced), offset);
...
#line 409 "src/jit/emit_x64.dasc"
            ...
            //| get_vmnull TMP3;
            //|3:
            dasm_put(Dst, 316, Dt13(->instance), Dt6(->VMNull));
...
#line 419 "src/jit/emit_x64.dasc"
            ...
            dasm_put(Dst, 339, Dt15(->effective_spesh_slots), DtC([spesh_idx]));
#line 421 "src/jit/emit_x64.dasc"
            ...
            //|3:
            dasm_put(Dst, 350, Dt8(->flags), MVM_CF_SECOND_GEN, Dt8(->flags), MVM_CF_SECOND_GEN, Dt14([obj]), (unsigned int)((uintptr_t)&MVM_gc_write_barrier_hit), (unsigned int)(((uintptr_t)&MVM_gc_write_barrier_hit)>>32));
...
#line 438 "src/jit/emit_x64.dasc"
            ...
            //| mov TMP3, RV;
            dasm_put(Dst, 464, Dt15(->effective_spesh_slots), DtC([spesh_idx]), (unsigned int)((uintptr_t)&MVM_repr_clone), (unsigned int)(((uintptr_t)&MVM_repr_clone)>>32));
...
#line 450 "src/jit/emit_x64.dasc"
            ...
            //|3:
            //| mov [TMP2], TMP3;
            dasm_put(Dst, 490, Dt8(->flags), MVM_CF_SECOND_GEN, Dt8(->flags), MVM_CF_SECOND_GEN, Dt14([obj]), (unsigned int)((uintptr_t)&MVM_gc_write_barrier_hit), (unsigned int)(((uintptr_t)&MVM_gc_write_barrier_hit)>>32));
...
#line 468 "src/jit/emit_x64.dasc"
    ...
    case MVM_OP_sp_p6obind_s: {
        ...
        //|1:
        dasm_put(Dst, 595, Dt14([obj]), Dt14([val]), Dt4(->body), Dt5(->replaced), Dt5(->replaced));
#line 484 "src/jit/emit_x64.dasc"
        if (op == MVM_OP_sp_p6obind_o || op == MVM_OP_sp_p6obind_s) {
            ...
            //|2: // done
            dasm_put(Dst, 623, Dt8(->flags), MVM_CF_SECOND_GEN, Dt8(->flags), MVM_CF_SECOND_GEN, Dt14([obj]), (unsigned int)((uintptr_t)&MVM_gc_write_barrier_hit), (unsigned int)(((uintptr_t)&MVM_gc_write_barrier_hit)>>32));
#line 494 "src/jit/emit_x64.dasc"
        }
        //| mov [TMP3+offset], TMP2; // store value into body
        dasm_put(Dst, 719, offset);
#line 496 "src/jit/emit_x64.dasc"
    ...
    case MVM_OP_set: {
         ...
         //| mov TMP1, WORK[reg2];
         //| mov WORK[reg1], TMP1;
         dasm_put(Dst, 724, Dt14([reg2]), Dt14([reg1]));
#line 504 "src/jit/emit_x64.dasc"
    ...
    case MVM_OP_sp_getspeshslot: {
        ...
        //| mov WORK[dst], TMP1;
        dasm_put(Dst, 265, Dt15(->effective_spesh_slots), DtC([spesh_idx]), Dt14([dst]));
#line 511 "src/jit/emit_x64.dasc"
    ...
    case MVM_OP_setdispatcher: {
        ...
        dasm_put(Dst, 733, Dt14([src]), Dt13(->cur_dispatcher));
#line 517 "src/jit/emit_x64.dasc"
    ...
    case MVM_OP_takedispatcher: {
        ...
        dasm_put(Dst, 742, Dt13(->cur_dispatcher), Dt14([dst]), Dt13(->cur_dispatcher), NULL);
...
#line 532 "src/jit/emit_x64.dasc"
    ...
    case MVM_OP_hllboxtype_i: {
        ...
        dasm_put(Dst, 756, Dt16(->body.hll_config));
...
#line 563 "src/jit/emit_x64.dasc"
    ...
    case MVM_OP_mod_i: {
        ...
        //| mov rax, WORK[reg_b];
        dasm_put(Dst, 800, Dt14([reg_b]));
#line 575 "src/jit/emit_x64.dasc"
        switch(ins->info->opcode) {
        case MVM_OP_add_i:
            //| add rax, WORK[reg_c];
            dasm_put(Dst, 805, Dt14([reg_c]));
#line 578 "src/jit/emit_x64.dasc"
            break;
        case MVM_OP_sub_i:
            //| sub rax, WORK[reg_c];
            dasm_put(Dst, 810, Dt14([reg_c]));
#line 581 "src/jit/emit_x64.dasc"
            break;
        case MVM_OP_mul_i:
            //| imul rax, WORK[reg_c];
            dasm_put(Dst, 815, Dt14([reg_c]));
...
#line 591 "src/jit/emit_x64.dasc"
        ...
        if (ins->info->opcode == MVM_OP_mod_i) {
            ...
            //| mov WORK[reg_a], rdx;
            dasm_put(Dst, 795, Dt14([reg_a]));
#line 596 "src/jit/emit_x64.dasc"
        } else {
            // all others in rax
            //| mov WORK[reg_a], rax;
            dasm_put(Dst, 829, Dt14([reg_a]));
...
#line 637 "src/jit/emit_x64.dasc"
    ...
    case MVM_OP_coerce_in: {
        ...
        dasm_put(Dst, 888, Dt14([src]), Dt14([dst]));
#line 645 "src/jit/emit_x64.dasc"
    ...
    case MVM_OP_coerce_ni: {
        ...
        //| mov WORK[dst], rax;
        dasm_put(Dst, 902, Dt14([src]), Dt14([dst]));
...
#line 694 "src/jit/emit_x64.dasc"
    ...
    case MVM_OP_not_i: {
        ...
        //| movzx TMP2, TMP2b;
        //| mov WORK[dst], TMP2;
        dasm_put(Dst, 952, Dt14([src]), Dt14([dst]));
...
#line 741 "src/jit/emit_x64.dasc"
    ...
    case MVM_OP_ishash: {
        ...
        //| mov qword WORK[dst], 0;
        //|2:
        dasm_put(Dst, 1032, Dt14([obj]), Dt7(->st), Dt9(->REPR), DtA(->ID), reprid, Dt14([dst]), Dt14([dst]));
#line 767 "src/jit/emit_x64.dasc"
    ...
    case MVM_OP_isnonnull: {
        ...
        //| movzx TMP2, TMP2b;
        //| mov WORK[dst], TMP2;
        dasm_put(Dst, 1085, Dt14([obj]), Dt13(->instance), Dt6(->VMNull), Dt14([dst]));
#line 781 "src/jit/emit_x64.dasc"
    ...
    case MVM_OP_isnull: {
        ...
        //| movzx TMP2, TMP2b;
        //| mov WORK[dst], TMP2;
        dasm_put(Dst, 1122, Dt14([obj]), Dt13(->instance), Dt6(->VMNull), Dt14([dst]));
#line 795 "src/jit/emit_x64.dasc"
    ...
    case MVM_OP_sp_fastcreate: {
        ...
        dasm_put(Dst, 1159, size, (unsigned int)((uintptr_t)&MVM_gc_allocate_zeroed), (unsigned int)(((uintptr_t)&MVM_gc_allocate_zeroed)>>32), Dt15(->effective_spesh_slots), DtC([spesh_idx]), Dt7(->st), Dt7(->header.size), size, Dt13(->thread_id), Dt7(->header.owner), Dt14([dst]));
#line 810 "src/jit/emit_x64.dasc"
    ...
    case MVM_OP_decont: {
        ...
        //| mov TMP5, WORK[src];
        //| test TMP5, TMP5;
        dasm_put(Dst, 1206, Dt14([src]));
#line 817 "src/jit/emit_x64.dasc"
        // obj is null
        //| jz >1;
        //| is_type_object TMP5;
        dasm_put(Dst, 1214, Dt7(->header.flags), MVM_CF_TYPE_OBJECT);
#line 820 "src/jit/emit_x64.dasc"
        ...
        //| test TMP6, TMP6;
        dasm_put(Dst, 1226, Dt7(->st), Dt9(->container_spec));
...
#line 837 "src/jit/emit_x64.dasc"
    ...
    case MVM_OP_sp_namedarg_used: {
        ...
        dasm_put(Dst, 1279, Dt15(->params.named_used), DtF([param]));
#line 843 "src/jit/emit_x64.dasc"
    ...
    case MVM_OP_sp_findmeth: {
        ...
        //| test RV, RV;
        //| jz >2;
        dasm_put(Dst, 1290, Dt15(->effective_spesh_slots), DtC([ss_idx]), Dt14([obj]), Dt7(->st), Dt15(->effective_spesh_slots), DtC([ss_idx + 1]), Dt14([dst]), Dt14([obj]), Dt16(->body.strings), DtB([str_idx]), ss_idx, Dt14([dst]), (unsigned int)((uintptr_t)&MVM_6model_find_method_spesh), (unsigned int)(((uintptr_t)&MVM_6model_find_method_spesh)>>32));
#line 872 "src/jit/emit_x64.dasc"
        ...
        //| jmp ->out;
        //|2:
        dasm_put(Dst, 1380, Dt15(->jit_entry_label));
#line 878 "src/jit/emit_x64.dasc"
    ...
    case MVM_OP_isconcrete: {
        ...
        //| mov qword WORK[dst], 0;
        //|2:
        dasm_put(Dst, 1405, Dt14([obj]), Dt7(->header.flags), MVM_CF_TYPE_OBJECT, Dt14([dst]), Dt14([dst]));
...
#line 922 "src/jit/emit_x64.dasc"
    ...
    case MVM_JIT_REG_VAL:
        ...
        dasm_put(Dst, 1475, Dt14([arg.v.reg]));
...
#line 939 "src/jit/emit_x64.dasc"
    ...
    case MVM_JIT_LITERAL_F:
        ...
        dasm_put(Dst, 1499, (unsigned int)(arg.v.lit_i64), (unsigned int)((arg.v.lit_i64)>>32));
#line 944 "src/jit/emit_x64.dasc"
        break;
    }
}
...
#line 1122 "src/jit/emit_x64.dasc"
    ...
    dasm_put(Dst, 228, (unsigned int)((uintptr_t)call_spec->func_ptr), (unsigned int)(((uintptr_t)call_spec->func_ptr)>>32));
...
#line 1141 "src/jit/emit_x64.dasc"
    ...
    case MVM_JIT_RV_ADDR:
        ...
        //| mov [RV], TMP1;
        dasm_put(Dst, 1574, Dt14([call_spec->rv_idx]));
...
void MVM_jit_emit_branch(MVMThreadContext *tc, MVMJitGraph *jg,
    ...
    //| gc_sync_point;
    dasm_put(Dst, 1582, Dt13(->gc_status), (unsigned int)((uintptr_t)&MVM_gc_enter_from_interrupt), (unsigned int)(((uintptr_t)&MVM_gc_enter_from_interrupt)>>32));
#line 1157 "src/jit/emit_x64.dasc"
    if (ins == NULL || ins->info->opcode == MVM_OP_goto) {
        ...
        if (name == MVM_JIT_BRANCH_EXIT) {
            //| jmp ->exit
            dasm_put(Dst, 1606);
#line 1161 "src/jit/emit_x64.dasc"
        } else {
            //| jmp =>(name)
            dasm_put(Dst, 1611, (name));
#line 1163 "src/jit/emit_x64.dasc"
        ...
        case MVM_OP_if_i:
            ...
            dasm_put(Dst, 1615, Dt14([val]), (name));
#line 1173 "src/jit/emit_x64.dasc"
        ...
        case MVM_OP_unless_i:
            ...
            //| test rax, rax;
            //| jz =>(name);
            dasm_put(Dst, 1626, Dt14([val]), (name));
#line 1178 "src/jit/emit_x64.dasc"
        ...
        case MVM_OP_ifnonnull:
            ...
            //| jmp =>(name);
            //|1:
            dasm_put(Dst, 1637, Dt14([val]), Dt13(->instance), Dt6(->VMNull), (name));
#line 1188 "src/jit/emit_x64.dasc"
        ...
        case MVM_OP_indexat: {
            ...
            //| cmp RV, 0;
            //| jl =>(name);
            dasm_put(Dst, 1669, Dt14([val]), Dt14([offset]), Dt16(->body.strings), DtB([str_idx]), (unsigned int)((uintptr_t)&MVM_string_char_at_in_string), (unsigned int)(((uintptr_t)&MVM_string_char_at_in_string)>>32), (name));
#line 1199 "src/jit/emit_x64.dasc"
            break;
        }
        default:
...
void MVM_jit_emit_guard(MVMThreadContext *tc, MVMJitGraph *jg,
    ...
    dasm_put(Dst, 1706, Dt14([obj]), Dt15(->effective_spesh_slots), DtC([spesh_idx]));
#line 1222 "src/jit/emit_x64.dasc"
...
#line 1229 "src/jit/emit_x64.dasc"
        ...
        //| is_type_object TMP1;
        dasm_put(Dst, 1731, Dt7(->header.flags), MVM_CF_TYPE_OBJECT);
...
#line 1236 "src/jit/emit_x64.dasc"
        ...
        //| je >1;
        dasm_put(Dst, 1721);
#line 1241 "src/jit/emit_x64.dasc"
        /* shouldn't be type object */
        //| is_type_object TMP1;
        //| jnz >1;
        dasm_put(Dst, 1747, Dt7(->header.flags), MVM_CF_TYPE_OBJECT);
...
#line 1251 "src/jit/emit_x64.dasc"
    ...
    dasm_put(Dst, 1758, guard->deopt_offset, guard->deopt_target, (unsigned int)((uintptr_t)&MVM_spesh_deopt_one_direct), (unsigned int)(((uintptr_t)&MVM_spesh_deopt_one_direct)>>32));
#line 1256 "src/jit/emit_x64.dasc"
    /* tell jit driver we're deopting */
    //| mov RV, MVM_JIT_CTRL_DEOPT
    //| jmp ->out;
    //|2:
    dasm_put(Dst, 1779, MVM_JIT_CTRL_DEOPT);
#line 1260 "src/jit/emit_x64.dasc"
}
...
void MVM_jit_emit_invoke(MVMThreadContext *tc, MVMJitGraph *jg, MVMJitInvoke *invoke,
    ...
    dasm_put(Dst, 1790, invoke->callsite_idx, (unsigned int)((uintptr_t)&MVM_args_prepare), (unsigned int)(((uintptr_t)&MVM_args_prepare)>>32));
#line 1272 "src/jit/emit_x64.dasc"
    /* Store arguments in the buffer. I use TMP5 as it never conflicts
     * with argument passing (like TMP6, but unlike other TMP regs) */
    //| mov TMP5, FRAME->args;
    dasm_put(Dst, 1814, Dt15(->args));
#line 1275 "src/jit/emit_x64.dasc"
    for (i = 0;  i < invoke->arg_count; i++) {
        ...
        case MVM_OP_arg_o: {
            ...
            dasm_put(Dst, 1821, Dt14([src]), Dt1([dst]));
#line 1286 "src/jit/emit_x64.dasc"
        ...
        case MVM_OP_argconst_i: {
            ...
            //| mov64 TMP4, val;
            //| mov REGISTER:TMP5[dst], TMP4;
            dasm_put(Dst, 1830, (unsigned int)(val), (unsigned int)((val)>>32), Dt1([dst]));
#line 1294 "src/jit/emit_x64.dasc"
        ...
        case MVM_OP_argconst_s: {
            ...
            //| get_string TMP4, idx;
            //| mov REGISTER:TMP5[dst], TMP4;
            dasm_put(Dst, 1839, Dt16(->body.strings), DtB([idx]), Dt1([dst]));
#line 1301 "src/jit/emit_x64.dasc"
    ...
    if (sizeof(MVMReturnType) == 4) {
        ...
        dasm_put(Dst, 1852, Dt15(->return_type), invoke->return_type);
#line 1312 "src/jit/emit_x64.dasc"
    } else {
...
#line 1325 "src/jit/emit_x64.dasc"
    ...
    dasm_put(Dst, 1893, (invoke->reentry_label), Dt15(->jit_entry_label));
#line 1329 "src/jit/emit_x64.dasc"
...
#line 1335 "src/jit/emit_x64.dasc"
        ...
        dasm_put(Dst, 1925, Dt14([invoke->code_register]), (unsigned int)((uintptr_t)&MVM_frame_find_invokee_multi_ok), (unsigned int)(((uintptr_t)&MVM_frame_find_invokee_multi_ok)>>32));
...
#line 1349 "src/jit/emit_x64.dasc"
        ...
        //| call FUNCTION;
        dasm_put(Dst, 1990, Dt7(->st), Dt9(->invoke));
#line 1353 "src/jit/emit_x64.dasc"
    } else {
        ...
        dasm_put(Dst, 2003, Dt14([invoke->code_register]), invoke->spesh_cand, (unsigned int)((uintptr_t)&MVM_frame_invoke_code), (unsigned int)(((uintptr_t)&MVM_frame_invoke_code)>>32));
#line 1360 "src/jit/emit_x64.dasc"
    ...
    //| jmp ->out;
    dasm_put(Dst, 2027);
#line 1364 "src/jit/emit_x64.dasc"
}
...
void MVM_jit_emit_jumplist(MVMThreadContext *tc, MVMJitGraph *jg,
    ...
    //|.align 8;
    //|1:
    dasm_put(Dst, 2039, Dt14([jumplist->reg]), jumplist->num_labels);
#line 1381 "src/jit/emit_x64.dasc"
    for (i = 0; i < jumplist->num_labels; i++) {
        //|=>(jumplist->in_labels[i]):
        //| jmp =>(jumplist->out_labels[i]);
        //|.align 8;
        dasm_put(Dst, 2081, (jumplist->in_labels[i]), (jumplist->out_labels[i]));
...
void MVM_jit_emit_control(MVMThreadContext *tc, MVMJitGraph *jg,
    ...
    if (ctrl->type == MVM_JIT_CONTROL_INVOKISH) {
        ...
        //| jmp ->out;
        //|1:
        dasm_put(Dst, 2088, Dt13(->cur_frame), Dt15(->jit_entry_label));
#line 1400 "src/jit/emit_x64.dasc"
        ...
        //|=>(i + jg->num_labels):
        dasm_put(Dst, 314, (i + jg->num_labels));
