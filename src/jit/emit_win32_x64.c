...
//|.actionlist actions
static const unsigned char actions[1762] = {
  ...
  209,15,132,244,247,252,233,245,248,1,255,72,139,139,233,73,139,148,253,36,
  ...
  244,247,255,76,137,252,241,72,199,194,237,73,199,192,237,73,186,237,237,65,
  252,255,210,255,72,199,192,237,252,233,244,11,248,2,255,76,137,252,241,76,
  137,252,234,73,199,192,237,73,186,237,237,65,252,255,210,73,137,195,255,77,
  ...
  21,245,73,137,148,253,36,233,255,76,137,85,216,76,137,93,208,255,76,137,252,
  241,72,139,147,233,76,141,69,208,77,137,209,73,186,237,237,65,252,255,210,
  255,76,139,93,208,76,139,85,216,255,76,137,252,241,72,137,194,77,137,216,
  77,137,209,255,76,139,144,233,77,139,146,233,65,252,255,210,255,76,137,252,
  241,72,139,147,233,77,137,216,73,199,193,237,73,186,237,237,65,252,255,210,
  255,72,199,192,1,0,0,0,252,233,244,11,255,72,139,139,233,72,131,252,249,0,
  15,140,244,248,72,129,252,249,239,15,141,244,248,72,107,201,8,72,141,21,244,
  247,72,1,202,252,255,226,250,7,248,1,255,249,252,233,245,250,7,255,77,59,
  166,233,15,132,244,247,72,141,13,244,247,73,137,140,253,36,233,72,199,192,
  1,0,0,0,252,233,244,11,248,1,255,205,3,255
};
...
#line 1058 "src/jit/emit_x64.dasc"
        ...
        case MVM_OP_if_i:
            ...
            dasm_put(Dst, 1320, Dt13([reg]), (name));
#line 1068 "src/jit/emit_x64.dasc"
        ...
        case MVM_OP_unless_i:
            ...
            //| test rax, rax;
            //| jz =>(name);
            dasm_put(Dst, 1331, Dt13([reg]), (name));
#line 1073 "src/jit/emit_x64.dasc"
        ...
        case MVM_OP_ifnonnull:
            ...
            //| jmp =>(name);
            //|1:
            dasm_put(Dst, 1342, Dt13([reg]), Dt12(->instance), Dt6(->VMNull), (name));
...
void MVM_jit_emit_guard(MVMThreadContext *tc, MVMJitGraph *jg,
    ...
    dasm_put(Dst, 1374, Dt13([obj]), Dt14(->effective_spesh_slots), DtB([spesh_idx]));
...
#line 1112 "src/jit/emit_x64.dasc"
        ...
        //| is_type_object TMP1;
        dasm_put(Dst, 1399, Dt7(->header.flags), MVM_CF_TYPE_OBJECT);
...
#line 1124 "src/jit/emit_x64.dasc"
        ...
        //| is_type_object TMP1;
        //| jnz >1;
        dasm_put(Dst, 1415, Dt7(->header.flags), MVM_CF_TYPE_OBJECT);
...
#line 1134 "src/jit/emit_x64.dasc"
    ...
    dasm_put(Dst, 1426, guard->deopt_offset, guard->deopt_target, (unsigned int)((uintptr_t)&MVM_spesh_deopt_one_direct), (unsigned int)(((uintptr_t)&MVM_spesh_deopt_one_direct)>>32));
#line 1139 "src/jit/emit_x64.dasc"
    /* tell jit driver we're deopting */
    //| mov RV, MVM_JIT_CTRL_DEOPT
    //| jmp ->out;
    //|2:
    dasm_put(Dst, 1447, MVM_JIT_CTRL_DEOPT);
...
void MVM_jit_emit_invoke(MVMThreadContext *tc, MVMJitGraph *jg, MVMJitInvoke *invoke,
    ...
    dasm_put(Dst, 1458, invoke->callsite_idx, (unsigned int)((uintptr_t)&MVM_args_prepare), (unsigned int)(((uintptr_t)&MVM_args_prepare)>>32));
...
#line 1157 "src/jit/emit_x64.dasc"
    for (i = 0;  i < invoke->arg_count; i++) {
        ...
        case MVM_OP_arg_o: {
            ...
            dasm_put(Dst, 1489, Dt13([src]), Dt1([dst]));
#line 1168 "src/jit/emit_x64.dasc"
        ...
        case MVM_OP_argconst_i: {
            ...
            //| mov64 TMP4, val;
            //| mov REGISTER:TMP5[dst], TMP4;
            dasm_put(Dst, 1498, (unsigned int)(val), (unsigned int)((val)>>32), Dt1([dst]));
#line 1176 "src/jit/emit_x64.dasc"
        ...
        case MVM_OP_argconst_s: {
            ...
            //| get_string TMP4, idx;
            //| mov REGISTER:TMP5[dst], TMP4;
            dasm_put(Dst, 1507, Dt15(->body.strings), DtA([idx]), Dt1([dst]));
#line 1183 "src/jit/emit_x64.dasc"
    ...
    if (sizeof(MVMReturnType) == 4) {
        ...
        dasm_put(Dst, 1520, Dt14(->return_type), invoke->return_type);
...
#line 1207 "src/jit/emit_x64.dasc"
    ...
    dasm_put(Dst, 1561, (invoke->reentry_label), Dt14(->jit_entry_label));
...
#line 1217 "src/jit/emit_x64.dasc"
        ...
        dasm_put(Dst, 1581, Dt13([invoke->code_register]), (unsigned int)((uintptr_t)&MVM_frame_find_invokee_multi_ok), (unsigned int)(((uintptr_t)&MVM_frame_find_invokee_multi_ok)>>32));
...
#line 1231 "src/jit/emit_x64.dasc"
        ...
        //| call FUNCTION;
        dasm_put(Dst, 1628, Dt7(->st), Dt9(->invoke));
#line 1235 "src/jit/emit_x64.dasc"
        ...
        dasm_put(Dst, 1641, Dt13([invoke->code_register]), invoke->spesh_cand, (unsigned int)((uintptr_t)&MVM_frame_invoke_code), (unsigned int)(((uintptr_t)&MVM_frame_invoke_code)>>32));
...
void MVM_jit_emit_jumplist(MVMThreadContext *tc, MVMJitGraph *jg,
    ...
    //|.align 8;
    //|1:
    dasm_put(Dst, 1677, Dt13([jumplist->reg]), jumplist->num_labels);
#line 1262 "src/jit/emit_x64.dasc"
    for (i = 0; i < jumplist->num_labels; i++) {
        //|=>(jumplist->in_labels[i]):
        //| jmp =>(jumplist->out_labels[i]);
        //|.align 8;
        dasm_put(Dst, 1719, (jumplist->in_labels[i]), (jumplist->out_labels[i]));
...
void MVM_jit_emit_control(MVMThreadContext *tc, MVMJitGraph *jg,
    ...
    if (ctrl->type == MVM_JIT_CONTROL_INVOKISH) {
        ...
        //| jmp ->out;
        //|1:
        dasm_put(Dst, 1726, Dt12(->cur_frame), Dt14(->jit_entry_label));
