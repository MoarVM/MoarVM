...
//|.actionlist actions
static const unsigned char actions[1465] = {
  ...
  252,241,255,73,139,150,233,255,77,139,134,233,255,77,139,142,233,255,76,137,
  252,233,255,76,137,252,234,255,77,137,232,255,77,137,252,233,255,72,139,139,
  233,255,72,139,147,233,255,76,139,131,233,255,76,139,139,233,255,252,242,
  15,16,139,233,255,252,242,15,16,147,233,255,252,242,15,16,155,233,255,76,
  141,155,233,255,76,137,217,255,76,137,218,255,77,137,216,255,77,137,217,255,
  ...
  236,15,133,244,247,255,76,137,252,241,72,199,194,237,73,199,192,237,73,186,
  237,237,72,131,252,236,32,65,252,255,210,72,131,196,32,255,72,199,192,237,
  252,233,244,11,248,2,255,76,137,252,241,76,137,252,234,73,199,192,237,73,
  186,237,237,72,131,252,236,32,65,252,255,210,72,131,196,32,73,137,195,255,
  76,139,145,233,255,76,139,139,233,77,137,138,233,255,73,185,237,237,77,137,
  138,233,255,77,139,141,233,77,139,137,233,77,137,138,233,255,199,129,233,
  237,255,72,199,129,233,237,255,72,141,147,233,72,137,145,233,255,73,139,150,
  233,72,139,18,72,137,145,233,255,65,82,65,83,255,76,137,252,241,72,139,147,
  ...
  192,1,0,0,0,252,233,244,11,255
};
...
#line 770 "src/jit/emit_x64.dasc"
            ...
            case MVM_JIT_INTERP_FRAME:
                ...
                dasm_put(Dst, 114, Dt11(->cur_frame));
                        break;
                    case 1:
                dasm_put(Dst, 978, Dt11(->cur_frame));
                        break;
                    case 2:
                dasm_put(Dst, 983, Dt11(->cur_frame));
                        break;
                    case 3:
                dasm_put(Dst, 988, Dt11(->cur_frame));
                        break;
                    default:
                        MVM_exception_throw_adhoc(tc, "Can't JIT more than %d arguments", i);
                }
...
#line 776 "src/jit/emit_x64.dasc"
        ...
        case MVM_JIT_REG_VAL:
            ...
            switch(i) {
                case 0:
            dasm_put(Dst, 1012, Dt12([args[i].v.reg]));
                    break;
                case 1:
            dasm_put(Dst, 1017, Dt12([args[i].v.reg]));
                    break;
                case 2:
            dasm_put(Dst, 1022, Dt12([args[i].v.reg]));
                    break;
                case 3:
            dasm_put(Dst, 1027, Dt12([args[i].v.reg]));
                    break;
                default:
                    MVM_exception_throw_adhoc(tc, "Can't JIT more than %d arguments", i);
            }
#line 781 "src/jit/emit_x64.dasc"
        ...
        case MVM_JIT_REG_VAL_F:
            ...
            dasm_put(Dst, 712, Dt12([args[i].v.reg]));
                    break;
                case 1:
            dasm_put(Dst, 1032, Dt12([args[i].v.reg]));
                    break;
                case 2:
            dasm_put(Dst, 1039, Dt12([args[i].v.reg]));
                    break;
                case 3:
            dasm_put(Dst, 1046, Dt12([args[i].v.reg]));
                    break;
                default:
                    MVM_exception_throw_adhoc(tc, "Can't JIT more than %d arguments", i);
            }
...
#line 788 "src/jit/emit_x64.dasc"
        case MVM_JIT_LITERAL:
            ...
            switch(i) {
                case 0:
            dasm_put(Dst, 1074, args[i].v.lit_i64);
                    break;
                case 1:
            dasm_put(Dst, 1079, args[i].v.lit_i64);
                    break;
                case 2:
            dasm_put(Dst, 1084, args[i].v.lit_i64);
                    break;
                case 3:
            dasm_put(Dst, 1089, args[i].v.lit_i64);
                    break;
                default:
                    MVM_exception_throw_adhoc(tc, "Can't JIT more than %d arguments", i);
            }
#line 790 "src/jit/emit_x64.dasc"
        ...
        case MVM_JIT_LITERAL_F:
            ...
            //| addarg i, TMP6;
            dasm_put(Dst, 1094, (unsigned int)(args[i].v.lit_i64), (unsigned int)((args[i].v.lit_i64)>>32));
            switch(i) {
                case 0:
            dasm_put(Dst, 1058);
                    break;
...
#line 812 "src/jit/emit_x64.dasc"
    ...
    case MVM_JIT_RV_DEREF:
        ...
        dasm_put(Dst, 1099, Dt12([call_spec->rv_idx]));
#line 816 "src/jit/emit_x64.dasc"
    ...
    case MVM_JIT_RV_ADDR:
        ...
        //| mov [RV], TMP1;
        dasm_put(Dst, 1107, Dt12([call_spec->rv_idx]));
...
#line 835 "src/jit/emit_x64.dasc"
        ...
        case MVM_OP_if_i:
            ...
            dasm_put(Dst, 1124, Dt12([reg]), (name));
#line 845 "src/jit/emit_x64.dasc"
        ...
        case MVM_OP_unless_i:
            ...
            //| test rax, rax;
            //| jz =>(name);
            dasm_put(Dst, 1135, Dt12([reg]), (name));
...
void MVM_jit_emit_guard(MVMThreadContext *tc, MVMJitGraph *jg,
    ...
    dasm_put(Dst, 1146, Dt12([obj]), Dt11(->cur_frame), Dt1(->effective_spesh_slots), DtC([spesh_idx]));
...
#line 879 "src/jit/emit_x64.dasc"
        ...
        //| is_type_object TMP1;
        dasm_put(Dst, 1173, Dt8(->header.flags), MVM_CF_TYPE_OBJECT);
...
#line 891 "src/jit/emit_x64.dasc"
        ...
        //| is_type_object TMP1;
        //| jnz >1;
        dasm_put(Dst, 1189, Dt8(->header.flags), MVM_CF_TYPE_OBJECT);
...
#line 901 "src/jit/emit_x64.dasc"
    ...
    dasm_put(Dst, 1200, guard->deopt_offset, guard->deopt_target, (unsigned int)((uintptr_t)&MVM_spesh_deopt_one_direct), (unsigned int)(((uintptr_t)&MVM_spesh_deopt_one_direct)>>32));
#line 906 "src/jit/emit_x64.dasc"
    /* tell jit driver we're deopting */
    //| mov RV, MVM_JIT_CTRL_DEOPT
    //| jmp ->out;
    //|2:
    dasm_put(Dst, 1230, MVM_JIT_CTRL_DEOPT);
...
void MVM_jit_emit_invoke(MVMThreadContext *tc, MVMJitGraph *jg, MVMJitInvoke *invoke,
    ...
    dasm_put(Dst, 1241, invoke->callsite_idx, (unsigned int)((uintptr_t)&MVM_args_prepare), (unsigned int)(((uintptr_t)&MVM_args_prepare)>>32));
...
#line 926 "src/jit/emit_x64.dasc"
    for (i = 0;  i < invoke->arg_count; i++) {
        ...
        case MVM_OP_arg_o: {
            ...
            dasm_put(Dst, 1279, Dt12([src]), Dt2([dst]));
#line 937 "src/jit/emit_x64.dasc"
        ...
        case MVM_OP_argconst_i: {
            ...
            //| mov64 TMP4, val;
            //| mov REGISTER:TMP5[dst], TMP4;
            dasm_put(Dst, 1288, (unsigned int)(val), (unsigned int)((val)>>32), Dt2([dst]));
#line 945 "src/jit/emit_x64.dasc"
        ...
        case MVM_OP_argconst_s: {
            ...
            //| get_string TMP4, idx;
            //| mov REGISTER:TMP5[dst], TMP4;
            dasm_put(Dst, 1297, Dt14(->body.strings), DtB([idx]), Dt2([dst]));
#line 952 "src/jit/emit_x64.dasc"
    ...
    if (sizeof(MVMReturnType) == 4) {
        ...
        dasm_put(Dst, 1310, Dt1(->return_type), invoke->return_type);
...
#line 976 "src/jit/emit_x64.dasc"
    ...
    dasm_put(Dst, 1310, Dt1(->jit_entry_label), invoke->reentry_label);
...
#line 985 "src/jit/emit_x64.dasc"
        ...
        dasm_put(Dst, 1347, Dt12([invoke->code_register]), (unsigned int)((uintptr_t)&MVM_frame_find_invokee_multi_ok), (unsigned int)(((uintptr_t)&MVM_frame_find_invokee_multi_ok)>>32));
...
#line 999 "src/jit/emit_x64.dasc"
        ...
        //| callr FUNCTION;
        dasm_put(Dst, 1398, Dt8(->st), DtA(->invoke));
#line 1003 "src/jit/emit_x64.dasc"
        ...
        dasm_put(Dst, 1420, Dt12([invoke->code_register]), invoke->spesh_cand, (unsigned int)((uintptr_t)&MVM_frame_invoke_code), (unsigned int)(((uintptr_t)&MVM_frame_invoke_code)>>32));
