...
//|.actionlist actions
static const unsigned char actions[1533] = {
  ...
  255,76,139,131,233,255,76,139,139,233,255,76,139,155,233,65,83,255,252,242,
  15,16,139,233,255,252,242,15,16,147,233,255,252,242,15,16,155,233,255,252,
  242,15,16,163,233,255,252,242,15,16,171,233,255,252,242,15,16,179,233,255,
  252,242,15,16,187,233,255,76,141,155,233,255,77,139,157,233,77,139,155,233,
  ...
  237,237,255,72,139,8,72,137,139,233,255,72,139,139,233,72,137,8,255,73,131,
  190,233,0,15,132,244,247,76,137,252,247,73,186,237,237,65,252,255,210,248,
  1,255,252,233,244,10,255,252,233,245,255,72,139,131,233,72,133,192,15,133,
  245,255,72,139,131,233,72,133,192,15,132,245,255,72,139,139,233,72,133,201,
  15,132,245,73,139,150,233,72,139,146,233,72,57,209,15,132,245,255,72,139,
  ...
  73,137,148,253,36,233,255,65,82,65,83,255,76,137,252,247,72,139,179,233,72,
  137,226,76,137,209,73,186,237,237,65,252,255,210,255,65,91,65,90,255,76,137,
  252,247,72,137,198,76,137,218,76,137,209,255,76,139,144,233,77,139,146,233,
  65,252,255,210,255,76,137,252,247,72,139,179,233,76,137,218,72,199,193,237,
  73,186,237,237,65,252,255,210,255,72,199,192,1,0,0,0,252,233,244,11,255
};
...
#line 783 "src/jit/emit_x64.dasc"
        ...
        case MVM_JIT_REG_VAL:
            ...
            dasm_put(Dst, 1012, Dt11([args[i].v.reg]));
                    break;
                case 1:
            dasm_put(Dst, 1017, Dt11([args[i].v.reg]));
                    break;
                case 2:
            dasm_put(Dst, 1022, Dt11([args[i].v.reg]));
                    break;
                case 3:
            dasm_put(Dst, 1027, Dt11([args[i].v.reg]));
                    break;
                case 4:
            dasm_put(Dst, 1032, Dt11([args[i].v.reg]));
                    break;
                case 5:
            dasm_put(Dst, 1037, Dt11([args[i].v.reg]));
                    break;
                default:
            dasm_put(Dst, 1042, Dt11([args[i].v.reg]));
                     break;
            }
#line 788 "src/jit/emit_x64.dasc"
        ...
        case MVM_JIT_REG_VAL_F:
            ...
            dasm_put(Dst, 650, Dt11([args[i].v.reg]));
                    break;
                case 1:
            dasm_put(Dst, 1049, Dt11([args[i].v.reg]));
                    break;
                case 2:
            dasm_put(Dst, 1056, Dt11([args[i].v.reg]));
                    break;
                case 3:
            dasm_put(Dst, 1063, Dt11([args[i].v.reg]));
                    break;
                case 4:
            dasm_put(Dst, 1070, Dt11([args[i].v.reg]));
                    break;
                case 5:
            dasm_put(Dst, 1077, Dt11([args[i].v.reg]));
                    break;
                case 6:
            dasm_put(Dst, 1084, Dt11([args[i].v.reg]));
                    break;
                case 7:
            dasm_put(Dst, 1091, Dt11([args[i].v.reg]));
                    break;
                default:
            dasm_put(Dst, 1042, Dt11([args[i].v.reg]));
                    break;
...
#line 791 "src/jit/emit_x64.dasc"
        ...
        case MVM_JIT_REG_ADDR:
            ...
            //| addarg i, TMP6;
            dasm_put(Dst, 1098, Dt11([args[i].v.reg]));
            switch(i) {
                case 0:
            dasm_put(Dst, 982);
                    break;
...
#line 795 "src/jit/emit_x64.dasc"
        ...
        case MVM_JIT_STR_IDX:    
            ...
            //| addarg i, TMP6;
            dasm_put(Dst, 1103, Dt13(->body.strings), DtA([args[i].v.lit_i64]));
            switch(i) {
                case 0:
            dasm_put(Dst, 982);
                    break;
...
#line 799 "src/jit/emit_x64.dasc"
        ...
        case MVM_JIT_LITERAL:
            ...
            switch(i) {
                case 0:
            dasm_put(Dst, 1112, args[i].v.lit_i64);
                    break;
                case 1:
            ...
            dasm_put(Dst, 1137, args[i].v.lit_i64);
                    break;
                default:
            dasm_put(Dst, 1142, args[i].v.lit_i64);
                     break;
            }
#line 802 "src/jit/emit_x64.dasc"
        ...
        case MVM_JIT_LITERAL_PTR:
            ...
            //| addarg i, TMP6;
            dasm_put(Dst, 1149, (unsigned int)(args[i].v.lit_i64), (unsigned int)((args[i].v.lit_i64)>>32));
            switch(i) {
                case 0:
            dasm_put(Dst, 982);
                    break;
...
#line 825 "src/jit/emit_x64.dasc"
    ...
    case MVM_JIT_RV_DEREF:
        ...
        dasm_put(Dst, 1154, Dt11([call_spec->rv_idx]));
#line 829 "src/jit/emit_x64.dasc"
    ...
    case MVM_JIT_RV_ADDR:
        ...
        //| mov [RV], TMP1;
        dasm_put(Dst, 1162, Dt11([call_spec->rv_idx]));
...
#line 851 "src/jit/emit_x64.dasc"
        ...
        case MVM_OP_if_i:
            ...
            dasm_put(Dst, 1203, Dt11([reg]), (name));
#line 861 "src/jit/emit_x64.dasc"
        ...
        case MVM_OP_unless_i:
            ...
            //| test rax, rax;
            //| jz =>(name);
            dasm_put(Dst, 1214, Dt11([reg]), (name));
#line 866 "src/jit/emit_x64.dasc"
        ...
        case MVM_OP_ifnonnull:
            ...
            //| cmp TMP1, TMP2;
            //| je =>(name);
            dasm_put(Dst, 1225, Dt11([reg]), (name), Dt10(->instance), Dt6(->VMNull), (name));
...
void MVM_jit_emit_guard(MVMThreadContext *tc, MVMJitGraph *jg,
    ...
    dasm_put(Dst, 1250, Dt11([obj]), Dt12(->effective_spesh_slots), DtB([spesh_idx]));
...
#line 903 "src/jit/emit_x64.dasc"
        ...
        //| is_type_object TMP1;
        dasm_put(Dst, 1275, Dt7(->header.flags), MVM_CF_TYPE_OBJECT);
...
#line 915 "src/jit/emit_x64.dasc"
        ...
        //| is_type_object TMP1;
        //| jnz >1;
        dasm_put(Dst, 1291, Dt7(->header.flags), MVM_CF_TYPE_OBJECT);
...
#line 925 "src/jit/emit_x64.dasc"
    ...
    dasm_put(Dst, 1302, guard->deopt_offset, guard->deopt_target, (unsigned int)((uintptr_t)&MVM_spesh_deopt_one_direct), (unsigned int)(((uintptr_t)&MVM_spesh_deopt_one_direct)>>32));
#line 930 "src/jit/emit_x64.dasc"
    /* tell jit driver we're deopting */
    //| mov RV, MVM_JIT_CTRL_DEOPT
    //| jmp ->out;
    //|2:
    dasm_put(Dst, 1323, MVM_JIT_CTRL_DEOPT);
...
void MVM_jit_emit_invoke(MVMThreadContext *tc, MVMJitGraph *jg, MVMJitInvoke *invoke,
    ...
    dasm_put(Dst, 1334, invoke->callsite_idx, (unsigned int)((uintptr_t)&MVM_args_prepare), (unsigned int)(((uintptr_t)&MVM_args_prepare)>>32));
...
#line 948 "src/jit/emit_x64.dasc"
    for (i = 0;  i < invoke->arg_count; i++) {
        ...
        case MVM_OP_arg_o: {
            ...
            dasm_put(Dst, 1365, Dt11([src]), Dt1([dst]));
#line 959 "src/jit/emit_x64.dasc"
        ...
        case MVM_OP_argconst_i: {
            ...
            //| mov64 TMP4, val;
            //| mov REGISTER:TMP5[dst], TMP4;
            dasm_put(Dst, 1374, (unsigned int)(val), (unsigned int)((val)>>32), Dt1([dst]));
#line 967 "src/jit/emit_x64.dasc"
        ...
        case MVM_OP_argconst_s: {
            ...
            //| get_string TMP4, idx;
            //| mov REGISTER:TMP5[dst], TMP4;
            dasm_put(Dst, 1383, Dt13(->body.strings), DtA([idx]), Dt1([dst]));
#line 974 "src/jit/emit_x64.dasc"
    ...
    if (sizeof(MVMReturnType) == 4) {
        ...
        dasm_put(Dst, 1396, Dt12(->return_type), invoke->return_type);
...
#line 998 "src/jit/emit_x64.dasc"
    ...
    dasm_put(Dst, 1396, Dt12(->jit_entry_label), invoke->reentry_label);
...
#line 1006 "src/jit/emit_x64.dasc"
        ...
        dasm_put(Dst, 1442, Dt11([invoke->code_register]), (unsigned int)((uintptr_t)&MVM_frame_find_invokee_multi_ok), (unsigned int)(((uintptr_t)&MVM_frame_find_invokee_multi_ok)>>32));
...
#line 1020 "src/jit/emit_x64.dasc"
        ...
        //| callr FUNCTION;
        dasm_put(Dst, 1484, Dt7(->st), Dt9(->invoke));
#line 1024 "src/jit/emit_x64.dasc"
        ...
        dasm_put(Dst, 1497, Dt11([invoke->code_register]), invoke->spesh_cand, (unsigned int)((uintptr_t)&MVM_frame_invoke_code), (unsigned int)(((uintptr_t)&MVM_frame_invoke_code)>>32));
