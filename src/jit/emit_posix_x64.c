...
//|.actionlist actions
static const unsigned char actions[1733] = {
  ...
  129,233,1,255,76,137,252,247,255,76,137,252,246,255,76,137,252,242,255,76,
  137,252,241,255,77,137,252,240,255,77,137,252,241,255,76,137,231,255,76,137,
  230,255,76,137,226,255,77,137,224,255,77,137,225,255,76,137,252,239,255,76,
  137,252,238,255,76,137,252,234,255,76,137,252,233,255,77,137,232,255,77,137,
  252,233,255,77,141,156,253,36,233,255,76,137,223,255,76,137,222,255,76,137,
  218,255,76,137,217,255,77,137,216,255,77,137,217,255,72,139,187,233,255,72,
  139,179,233,255,72,139,147,233,255,72,139,139,233,255,76,139,131,233,255,
  76,139,139,233,255,102,72,15,110,131,233,255,102,72,15,110,139,233,255,102,
  72,15,110,147,233,255,102,72,15,110,155,233,255,102,72,15,110,163,233,255,
  102,72,15,110,171,233,255,102,72,15,110,179,233,255,102,72,15,110,187,233,
  255,76,141,155,233,255,77,139,157,233,77,139,155,233,255,72,199,199,237,255,
  72,199,198,237,255,72,199,194,237,255,72,199,193,237,255,73,199,192,237,255,
  73,199,193,237,255,73,187,237,237,255,102,73,15,110,195,255,102,73,15,110,
  ...
  76,137,85,216,76,137,93,208,255,76,137,252,247,72,139,179,233,72,137,226,
  76,137,209,73,186,237,237,65,252,255,210,255,76,139,93,208,76,139,85,216,
  255,76,137,252,247,72,137,198,76,137,218,76,137,209,255,76,139,144,233,77,
  139,146,233,65,252,255,210,255,76,137,252,247,72,139,179,233,76,137,218,72,
  199,193,237,73,186,237,237,65,252,255,210,255,72,199,192,1,0,0,0,252,233,
  244,11,255,77,59,166,233,15,132,244,247,72,141,13,244,247,73,137,140,253,
...
#line 812 "src/jit/emit_x64.dasc"
    ...
    case MVM_JIT_REG_VAL:
        ...
        dasm_put(Dst, 1111, Dt13([arg.v.reg]));
                break;
            case 2:
        dasm_put(Dst, 1116, Dt13([arg.v.reg]));
                break;
            case 3:
        dasm_put(Dst, 1121, Dt13([arg.v.reg]));
                break;
            case 4:
        dasm_put(Dst, 1126, Dt13([arg.v.reg]));
                break;
            case 5:
        dasm_put(Dst, 1131, Dt13([arg.v.reg]));
                break;
            default:
                MVM_exception_throw_adhoc(tc, "JIT: adding %d arguments temporarily disabled\n", i);
        }
#line 817 "src/jit/emit_x64.dasc"
    ...
    case MVM_JIT_REG_VAL_F:
        ...
        dasm_put(Dst, 1143, Dt13([arg.v.reg]));
                break;
            case 2:
        dasm_put(Dst, 1150, Dt13([arg.v.reg]));
                break;
            case 3:
        dasm_put(Dst, 1157, Dt13([arg.v.reg]));
                break;
            case 4:
        dasm_put(Dst, 1164, Dt13([arg.v.reg]));
                break;
            case 5:
        dasm_put(Dst, 1171, Dt13([arg.v.reg]));
                break;
            case 6:
        dasm_put(Dst, 1178, Dt13([arg.v.reg]));
                break;
            case 7:
...
#line 820 "src/jit/emit_x64.dasc"
    ...
    case MVM_JIT_REG_ADDR:
        ...
        //| addarg i, TMP6;
        dasm_put(Dst, 1192, Dt13([arg.v.reg]));
        switch(i) {
            case 0:
        dasm_put(Dst, 1082);
                break;
...
#line 824 "src/jit/emit_x64.dasc"
    ...
    case MVM_JIT_STR_IDX:
        ...
        //| addarg i, TMP6;
        dasm_put(Dst, 1197, Dt15(->body.strings), DtA([arg.v.lit_i64]));
        switch(i) {
            case 0:
        dasm_put(Dst, 1082);
                break;
...
#line 828 "src/jit/emit_x64.dasc"
    ...
    case MVM_JIT_LITERAL:
        ...
        switch(i) {
            case 0:
        dasm_put(Dst, 1206, arg.v.lit_i64);
                break;
            case 1:
        dasm_put(Dst, 1211, arg.v.lit_i64);
                break;
            case 2:
        dasm_put(Dst, 1216, arg.v.lit_i64);
                break;
            case 3:
        dasm_put(Dst, 1221, arg.v.lit_i64);
                break;
            case 4:
        dasm_put(Dst, 1226, arg.v.lit_i64);
                break;
            case 5:
        dasm_put(Dst, 1231, arg.v.lit_i64);
                break;
            default:
                MVM_exception_throw_adhoc(tc, "JIT: adding %d arguments temporarily disabled\n", i);
        }
#line 831 "src/jit/emit_x64.dasc"
    ...
    case MVM_JIT_LITERAL_PTR:
        ...
        //| addarg i, TMP6;
        dasm_put(Dst, 1236, (unsigned int)(arg.v.lit_i64), (unsigned int)((arg.v.lit_i64)>>32));
        switch(i) {
            case 0:
        dasm_put(Dst, 1082);
                break;
...
#line 929 "src/jit/emit_x64.dasc"
    ...
    case MVM_JIT_RV_DEREF:
        ...
        dasm_put(Dst, 1292, Dt13([call_spec->rv_idx]));
#line 933 "src/jit/emit_x64.dasc"
    ...
    case MVM_JIT_RV_ADDR:
        ...
        //| mov [RV], TMP1;
        dasm_put(Dst, 1300, Dt13([call_spec->rv_idx]));
...
void MVM_jit_emit_branch(MVMThreadContext *tc, MVMJitGraph *jg,
    ...
    //| gc_sync_point;
    dasm_put(Dst, 1308, Dt12(->gc_status), (unsigned int)((uintptr_t)&MVM_gc_enter_from_interrupt), (unsigned int)(((uintptr_t)&MVM_gc_enter_from_interrupt)>>32));
...
#line 955 "src/jit/emit_x64.dasc"
        ...
        case MVM_OP_if_i:
            ...
            dasm_put(Dst, 1341, Dt13([reg]), (name));
#line 965 "src/jit/emit_x64.dasc"
        ...
        case MVM_OP_unless_i:
            ...
            //| test rax, rax;
            //| jz =>(name);
            dasm_put(Dst, 1352, Dt13([reg]), (name));
#line 970 "src/jit/emit_x64.dasc"
        ...
        case MVM_OP_ifnonnull:
            ...
            //| jmp =>(name);
            //|1:
            dasm_put(Dst, 1363, Dt13([reg]), Dt12(->instance), Dt6(->VMNull), (name));
...
void MVM_jit_emit_guard(MVMThreadContext *tc, MVMJitGraph *jg,
    ...
    dasm_put(Dst, 1395, Dt13([obj]), Dt14(->effective_spesh_slots), DtB([spesh_idx]));
...
#line 1009 "src/jit/emit_x64.dasc"
        ...
        //| is_type_object TMP1;
        dasm_put(Dst, 1420, Dt7(->header.flags), MVM_CF_TYPE_OBJECT);
...
#line 1031 "src/jit/emit_x64.dasc"
    ...
    dasm_put(Dst, 1447, guard->deopt_offset, guard->deopt_target, (unsigned int)((uintptr_t)&MVM_spesh_deopt_one_direct), (unsigned int)(((uintptr_t)&MVM_spesh_deopt_one_direct)>>32));
#line 1036 "src/jit/emit_x64.dasc"
    /* tell jit driver we're deopting */
    //| mov RV, MVM_JIT_CTRL_DEOPT
    //| jmp ->out;
    //|2:
    dasm_put(Dst, 1468, MVM_JIT_CTRL_DEOPT);
...
void MVM_jit_emit_invoke(MVMThreadContext *tc, MVMJitGraph *jg, MVMJitInvoke *invoke,
    ...
    dasm_put(Dst, 1479, invoke->callsite_idx, (unsigned int)((uintptr_t)&MVM_args_prepare), (unsigned int)(((uintptr_t)&MVM_args_prepare)>>32));
...
#line 1054 "src/jit/emit_x64.dasc"
    for (i = 0;  i < invoke->arg_count; i++) {
        ...
        case MVM_OP_arg_o: {
            ...
            dasm_put(Dst, 1510, Dt13([src]), Dt1([dst]));
#line 1065 "src/jit/emit_x64.dasc"
        ...
        case MVM_OP_argconst_i: {
            ...
            //| mov64 TMP4, val;
            //| mov REGISTER:TMP5[dst], TMP4;
            dasm_put(Dst, 1519, (unsigned int)(val), (unsigned int)((val)>>32), Dt1([dst]));
#line 1073 "src/jit/emit_x64.dasc"
        ...
        case MVM_OP_argconst_s: {
            ...
            //| get_string TMP4, idx;
            //| mov REGISTER:TMP5[dst], TMP4;
            dasm_put(Dst, 1528, Dt15(->body.strings), DtA([idx]), Dt1([dst]));
#line 1080 "src/jit/emit_x64.dasc"
    ...
    if (sizeof(MVMReturnType) == 4) {
        ...
        dasm_put(Dst, 1541, Dt14(->return_type), invoke->return_type);
...
#line 1104 "src/jit/emit_x64.dasc"
    ...
    dasm_put(Dst, 1582, (invoke->reentry_label), Dt14(->jit_entry_label));
...
#line 1114 "src/jit/emit_x64.dasc"
        ...
        dasm_put(Dst, 1602, Dt13([invoke->code_register]), (unsigned int)((uintptr_t)&MVM_frame_find_invokee_multi_ok), (unsigned int)(((uintptr_t)&MVM_frame_find_invokee_multi_ok)>>32));
...
void MVM_jit_emit_control(MVMThreadContext *tc, MVMJitGraph *jg,
    ...
    if (ctrl->type == MVM_JIT_CONTROL_INVOKISH) {
        ...
        //| jmp ->out;
        //|1:
        dasm_put(Dst, 1697, Dt12(->cur_frame), Dt14(->jit_entry_label));
