...
#line 97 "src/jit/x86_64.dasc"
    ...
    case MVM_OP_add_i: {
        ...
        //| mov rax, qword WORK[reg_b]
        //| add rax, qword WORK[reg_c]
        //| mov qword WORK[reg_a], rax
