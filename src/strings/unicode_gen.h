...
#define num_unicode_property_value_keypairs 3600

typedef enum {
    MVM_UNICODE_PROPERTY_MVM_COLLATION_PRIMARY = 1,
    MVM_UNICODE_PROPERTY_DECOMP_SPEC = 2,
    MVM_UNICODE_PROPERTY_SENTENCE_BREAK = 3,
    ...
    MVM_UNICODE_PROPERTY_MVM_COLLATION_SECONDARY = 8,
    MVM_UNICODE_PROPERTY_NUMERIC_VALUE = 9,
    MVM_UNICODE_PROPERTY_JOINING_GROUP = 10,
    MVM_UNICODE_PROPERTY_SCRIPT = 11,
    MVM_UNICODE_PROPERTY_NUMERIC_VALUE_NUMERATOR = 12,
    MVM_UNICODE_PROPERTY_SPECIAL_CASING = 13,
    MVM_UNICODE_PROPERTY_CANONICAL_COMBINING_CLASS = 14,
    MVM_UNICODE_PROPERTY_EAST_ASIAN_WIDTH = 15,
    MVM_UNICODE_PROPERTY_ASCII_HEX_DIGIT = 16,
    MVM_UNICODE_PROPERTY_LINE_BREAK = 17,
    MVM_UNICODE_PROPERTY_MVM_COLLATION_TERTIARY = 18,
    ...
    MVM_UNICODE_PROPERTY_WORD_BREAK = 25,
    MVM_UNICODE_PROPERTY_HANGUL_SYLLABLE_TYPE = 26,
    ...
    MVM_UNICODE_PROPERTY_EMOJI_COMPONENT = 52,
    ...
    MVM_UNICODE_PROPERTY_MVM_COLLATION_QC = 74,
    ...
    MVM_UNICODE_PROPERTY_REGIONAL_INDICATOR = 94,
    MVM_UNICODE_PROPERTY_S = 95,
    MVM_UNICODE_PROPERTY_SENTENCE_TERMINAL = 96,
    MVM_UNICODE_PROPERTY_SOFT_DOTTED = 97,
    MVM_UNICODE_PROPERTY_TERMINAL_PUNCTUATION = 98,
    MVM_UNICODE_PROPERTY_UNIFIED_IDEOGRAPH = 99,
    MVM_UNICODE_PROPERTY_UPPERCASE = 100,
    MVM_UNICODE_PROPERTY_VARIATION_SELECTOR = 101,
    MVM_UNICODE_PROPERTY_WHITE_SPACE = 102,
