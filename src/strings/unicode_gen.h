...
typedef enum {
    ...
    MVM_UNICODE_PROPERTY_CANONICAL_COMBINING_CLASS = 10,
    MVM_UNICODE_PROPERTY_JOINING_GROUP = 11,
    MVM_UNICODE_PROPERTY_BIDI_CLASS = 12,
    ...
    MVM_UNICODE_PROPERTY_SENTENCE_BREAK = 20,
    MVM_UNICODE_PROPERTY_GRAPHEME_CLUSTER_BREAK = 21,
    MVM_UNICODE_PROPERTY_ALPHABETIC = 22,
    MVM_UNICODE_PROPERTY_JOINING_TYPE = 23,
