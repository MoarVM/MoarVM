...
#define num_unicode_property_keypairs 3803
...
#define num_unicode_property_value_keypairs 3488
...
typedef enum {
    ...
    MVM_UNICODE_PROPERTY_MATH = 72,
    MVM_UNICODE_PROPERTY_N = 73,
    MVM_UNICODE_PROPERTY_NFD_QC = 74,
    MVM_UNICODE_PROPERTY_NFKD_QC = 75,
    MVM_UNICODE_PROPERTY_NONCHARACTER_CODE_POINT = 76,
    MVM_UNICODE_PROPERTY_OTHER_ALPHABETIC = 77,
