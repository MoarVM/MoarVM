...
#define num_unicode_property_keypairs 3755
...
#define num_unicode_property_value_keypairs 3320
...
typedef enum {
    ...
    MVM_UNICODE_PROPERTY_NFG_QC = 12,
    MVM_UNICODE_PROPERTY_CANONICAL_COMBINING_CLASS = 13,
    MVM_UNICODE_PROPERTY_GRAPHEME_CLUSTER_BREAK = 14,
    ...
    MVM_UNICODE_PROPERTY_MVM_SIMPLE_COLLATION = 66,
