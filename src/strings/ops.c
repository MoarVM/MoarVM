...
MVMObject * MVM_string_to_int(MVMThreadContext *tc, MVMint64 radix, MVMString *str, MVMint64 offset, MVMint64 flag) {
    MVMArray *result;
    MVMnum64 zvalue = 0.0;
    MVMnum64 zbase  = 1.0;
    ...
    result = (MVMArray *)MVM_repr_alloc_init(tc, tc->instance->boot_types->BOOTArray);
    repr_data = (MVMArrayREPRData *)(STABLE(result)->REPR_data);
