        ...
        for (i = 0; i < num_attrs; i++) {
            ...
            if (!MVM_is_null(tc, type)) {
                ...
                if (spec->inlineable == MVM_STORAGE_SPEC_INLINED &&
                    ...
                    switch (char_type) {
                        case MVM_P6STR_C_TYPE_CHAR:     str_type = MVM_CSTRUCT_ATTR_STRING;      break;
                        case MVM_P6STR_C_TYPE_WCHAR_T:  str_type = MVM_CSTRUCT_ATTR_WIDE_STRING; break;
                        case MVM_P6STR_C_TYPE_CHAR16_T: str_type = MVM_CSTRUCT_ATTR_U16_STRING;  break;
                        case MVM_P6STR_C_TYPE_CHAR32_T: str_type = MVM_CSTRUCT_ATTR_U32_STRING;  break;
                    }

                    repr_data->num_child_objs++;
                    repr_data->attribute_locations[i] = (cur_obj_attr++ << MVM_CSTRUCT_ATTR_SHIFT) | str_type;
