...
#define MVM_CUNION_ATTR_WIDE_STRING 7
#define MVM_CUNION_ATTR_U16_STRING  8
#define MVM_CUNION_ATTR_U32_STRING  9
#define MVM_CUNION_ATTR_MASK        15

#define MVM_CUNION_ATTR_INLINED   16

/* Bits to shift a slot position to make room for MVM_CUNION_ATTR_*. */
#define MVM_CUNION_ATTR_SHIFT     5
