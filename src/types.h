...
typedef struct MVMMultiDimArrayView MVMMultiDimArrayView;
typedef struct MVMMultiDimArrayViewBody MVMMultiDimArrayViewBody;
typedef struct MVMMultiDimArrayViewREPRData MVMMultiDimArrayViewREPRData;
