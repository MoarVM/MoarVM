...
typedef struct MVMCStructArray MVMCStructArray;
typedef struct MVMCStructArrayBody MVMCStructArrayBody;
typedef struct MVMCStructArrayREPRData MVMCStructArrayREPRData;
typedef struct MVMCStructArray MVMCStructArray;
