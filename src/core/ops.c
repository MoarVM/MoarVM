...
static const MVMOpInfo MVM_op_infos[] = {
    ...
    },
    {
        ...
        0,
        0,
        { MVM_operand_str, MVM_operand_int32, MVM_operand_int16, MVM_operand_spesh_slot }
    },
};

static const unsigned short MVM_op_counts = 818;
