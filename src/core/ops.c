...
static const MVMOpInfo MVM_op_infos[] = {
    ...
    },
    {
        ...
        0,
        0,
        { MVM_operand_write_reg | MVM_operand_int64, MVM_operand_read_reg | MVM_operand_int32, MVM_operand_read_reg | MVM_operand_int64 }
    },
    {
        MVM_OP_fstat_time,
        "fstat_time",
        ...
        0,
        0,
        { MVM_operand_write_reg | MVM_operand_num64, MVM_operand_read_reg | MVM_operand_int32, MVM_operand_read_reg | MVM_operand_int64 }
    },
    {
        MVM_OP_sp_guard,
        "sp_guard",
