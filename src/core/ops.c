...
static MVMOpInfo MVM_op_info_string[] = {
    ...
    },
    {
        ...
        "radix",
        5,
        { MVM_operand_write_reg | MVM_operand_obj, MVM_operand_read_reg | MVM_operand_int16, MVM_operand_read_reg | MVM_operand_str, MVM_operand_read_reg | MVM_operand_int64, MVM_operand_read_reg | MVM_operand_int16 }
    },
};
...
static MVMOpInfo MVM_op_info_io[] = {
    ...
    },
    {
        ...
        "open_fh",
        4,
        { MVM_operand_write_reg | MVM_operand_obj, MVM_operand_read_reg | MVM_operand_str, MVM_operand_read_reg | MVM_operand_int64, MVM_operand_read_reg | MVM_operand_int64 }
    },
    {
        MVM_OP_close_fh,
        "close_fh",
